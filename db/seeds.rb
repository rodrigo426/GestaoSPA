...
#User.create name: 'Rodrigo', status: :active, kind: :tecnico, email: 'rodrigomoura426@gmail.com', password: '123456'
...
#Client.create name: 'Vitor Ganiko', birthdate: 'June 9, 1997', email: 'vsganiko@teste.com', occupation: 'empresario'
#Client.create name: 'Vitor Festine', birthdate: 'September 9, 1997', email: 'vitao@teste.com', occupation: 'gerente'
#Client.create name: 'Rodrigo Moura', birthdate: 'December 22, 1995', email: 'rodrigo@teste.com', occupation: 'estudante'
#Client.create name: 'Kathleen Saraiva', birthdate: 'June 19, 1997', email: 'saraiva@teste.com', occupation: 'estudante'
