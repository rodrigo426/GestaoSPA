...
class CashiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cashier" do
    assert_difference('Cashier.count') do
      post cashiers_url, params: { cashier: { paid: @cashier.paid, paid_value: @cashier.paid_value, paymment: @cashier.paymment, price: @cashier.price } }
    end
  ...
  test "should update cashier" do
    patch cashier_url(@cashier), params: { cashier: { paid: @cashier.paid, paid_value: @cashier.paid_value, paymment: @cashier.paymment, price: @cashier.price } }
